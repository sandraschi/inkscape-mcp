    ...
    def register_tools(self, app: FastMCP) -> None:
        ...
        async def adjust_brightness_contrast(
            ...
            try:
                ...
                return self.create_success_response(
                    message="Brightness/contrast adjustment completed",
                    details={
        ...
        async def adjust_levels(
            ...
            try:
                ...
                # Validate channel
                valid_channels = {"value": 0, "red": 1, "green": 2, "blue": 3, "alpha": 4}
        ...
        async def adjust_curves(
            ...
            try:
                ...
                control_points = [
                    (max(0.0, min(1.0, x)), max(0.0, min(1.0, y))) for x, y in control_points
                ]
        ...
        async def adjust_posterize(
            ...
            try:
                ...
                return self.create_success_response(
                    ...
                    details={"levels": levels, "dither": dither, "output_path": output_path},
                )
        ...
        async def desaturate(
            ...
            try:
                ...
                return self.create_success_response(
                    ...
                    details={"mode": mode, "output_path": output_path},
                )
