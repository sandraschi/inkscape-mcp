                    ...
                    "tools": {
                        "resize_image": {
                            ...
                            "parameters": {
                                "width": "New width",
                                "height": "New height",
                                "maintain_aspect": "Keep proportions",
                            },
                ...
                "color_adjustments": {
                    ...
                    "tools": {
                        ...
                        "adjust_levels": {
                            ...
                            "parameters": {
                                "input_levels": "Input range",
                                "output_levels": "Output range",
                            },
                ...
                "filters": {
                    ...
                    "tools": {
                        ...
                        "apply_emboss": {
                            ...
                            "parameters": {
                                "azimuth": "Light direction",
                                "elevation": "Light height",
                            },
    ...
    def register_tools(self, app: FastMCP) -> None:
                ...
                return instance.create_success_response(
                    {
                        ...
                        "usage_examples": instance._help_data["usage_examples"][level][
                            :3
                        ],  # Top 3 examples
                    }
                )
        ...
        async def get_category_help(category: str, include_tools: bool = True) -> Dict[str, Any]:
            ...
            try:
                ...
                if include_tools:
                    response["tools"] = {
                        name: {"description": info["description"], "usage": info["usage"]}
        ...
        async def get_tool_help(tool_name: str, category: Optional[str] = None) -> Dict[str, Any]:
            ...
            try:
                ...
                search_categories = (
                    [category] if category else instance._help_data["categories"].keys()
                )
            ...
            try:
                ...
                for category_name, category in instance._help_data["categories"].items():
                    tools[category_name] = {
                        ...
                        "tools": {
                            name: info["description"] for name, info in category["tools"].items()
                        },
                    }
            ...
            try:
                ...
                if category:
                    ...
                    filtered_examples = [
                        ex
                        for ex in examples
                        if category in ex.lower()
                        or any(cat in ex.lower() for cat in instance._help_data["categories"])
                    ]
